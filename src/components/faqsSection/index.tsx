...
const text = [
    {
        title: 'How to get one or more Cootie NFT?',
        content: 'You will be able to purchase a Cootie NFT from our website when the public sale goes live December 24th at 3 PM EST. Once you Mint your Cootie, a Randomly selected NFT will be delivered to your Metamask or Bifrost wallet. You will then be able to see it or sale it on our marketplace.'
    },
    {
        title: 'What is the total supply of Cootie NFTs?',
        content: "There will be 4444 Cootie NFTs on each of the 4 blockchains. Once all Cooties have been sold, you'll only be able to buy a Cootie on a marketplace for a higher price then mint price."
    },
    {
        title: 'How to buy a Cootie NFT?',
        content: '<p>To buy a Cootie NFT when the public sale goes live on December 24th at 3pm EST, you will need the specific coin from the blockchain you desire to buy from. $AVAX For Avalanche, $Matic for Polygon, $BNB for Binance Smart Chain and $SGB For Songbird.</p>' + 
    ...
    },
    {
        ...
        content: 'Yes, Whitelisted individuals will be allowed to purchase 1 hour before the public sale with a max of 10 Cooties per wallet.'
    },
    {
    ...
    {
        title: 'What does holding a Cootie get me?',
        content: 'The Cooties will be minted on 4 different blockchains. Owning a Cootie will give you the chance to Yield our native currency $CootieCoin, which can be traded for Fiat or used to purchase NFTs or other items listed in the marketplace.'
    },
    {
        title: 'What is the Metaverse?',
        content: 'The Metaverse is the World 3.0. The word refers to a shared virtual reality where everything and anything can be bought and sold just like on the markets, using cryptocurrency. The Cooties will soon make a unique entrance into the Metaverse, through gaming and custom avatars.'
    }
]
